...
public class SessionSingleton {
	...
	public Session getSession(TestSetting setting) {
		...
		// If there is only one repository exposed,
	...
	public Session getSession(String[] defaultSetting) {

		String bindingType = defaultSetting[0];
		String bindingUrl = defaultSetting[1];
		String userName = defaultSetting[2];
		String userPwd = defaultSetting[3];
